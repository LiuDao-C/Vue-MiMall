              ...
              <li class="menu-item">
                 ...
                 <div class="children">
                   <ul v-for="(item,index) in menuList" v-bind:key="index">
                     <li v-for="(sub,index2) in item" v-bind:key="index2">
                       <a v-bind:href="sub.id?'/#/product/'+sub.id:''">
        ...
        <div class="container">
          ...
          <div class="list-box">
            <div class="list" v-for="(arr,index) in phoneList" v-bind:key="index">
              <div class="item" v-for="(item,index2) in arr" v-bind:key="index2">
                <span v-bind:class="{'new-pro':index2%2==0}">新品</span>
                <div class="item-img">
