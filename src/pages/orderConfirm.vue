        ...
        <div class="edit-wrap">
          ...
          <div class="item">
            ...
            <select name="city" v-model="checkedItem.receiverCity">
              <option value="北京">北京</option>。
              <option value="广东">汕头</option>
              <option value="湖南">衡阳</option>
            </select>
            <select name="district" v-model="checkedItem.receiverDistrict">
              <option value="北京">朝阳区</option>。
              <option value="广东">潮南区</option>
              <option value="湖南">蒸湘区</option>
            </select>
          </div>
          <div class="item">
...
export default {
    ...
    data() {
      return {
        ...
        count:0,  // 商品结算件数
        checkIndex:0, //当前选中的收获地址的索引
        checkedItem:{},  // 选中的商品对象
        userAction:'',  // 用户行为 0：新增 1：修改 2：删除
        showDelModal:false, // 是否显示删除确认弹框
        showEditModal:false, // 是否显示新增确认弹框
      }
    },
    components:{
      Modal,
